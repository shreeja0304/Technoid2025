...
export default function Hero() {
  return (
    <section className="h-screen flex flex-col items-center justify-center relative px-4 overflow-hidden">
      ...
      {/* 2. Video Background (Previous Year Style) */}
      <video
        autoPlay
        muted
        loop
        playsInline
        // Using the specific classes you requested: brightness-[0.25] and scale-125
        className="absolute inset-0 z-0 size-full object-cover brightness-[0.25] md:scale-125"
      >
      ...
      {/* --- CONTENT --- */}
      {/* z-20 ensures it sits above the video and vignette */}
      {/* -mt-20 pulls the content slightly UP from the dead center */}
      <div className="z-20 text-center space-y-6 max-w-5xl mx-auto -mt-16 relative">
